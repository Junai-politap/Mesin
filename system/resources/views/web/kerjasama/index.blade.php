...
<section class="bg-12 p-t-92 p-b-60">
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-sm-10 col-md-8 col-lg-3 p-b-40">
                <div class="bg-0 h-full">
                    <a href="{{ url("kerjasama/$kerjasama->id") }}" class="hov-img0 of-hidden">
                        <img src="{{ url("public/$kerjasama->foto") }}">
                    </a>

                    <div class="bg-0 p-rl-28 p-t-26 p-b-35">
                        <h4 class="p-b-12">
                            <a href="{{ url("kerjasama/$kerjasama->id") }}" class="t1-m-1 cl-3 hov-link2 trans-02">
                        ...
                        <p class="t1-s-2 cl-6 p-b-20">
                            {{ substr($kerjasama->detail,0,100) }} .........................
                        </p>

                        <a href="{{ url("kerjasama/$kerjasama->id") }}" class="d-inline-flex flex-c-c size-a-1 p-rl-15 t1-s-2 cl-0 bg-11 hov-btn1 trans-02">
                            Selengkapnya
                        </a>
                    </div>
                </div>

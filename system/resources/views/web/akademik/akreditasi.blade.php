    ...
    <div class="bg-10">
        <div class="container txt-center p-tb-15">
            <span class="t1-s-2 cl-14">
                <p style="font-size: 200%; color: white">Akreditasi Prodi D-III Perawatan dan Perbaikan Mesin</p>
            </span>
        </div>
    </div>
</section>
                    ...
                    <div class="timeline-content">
                        ...
                        <div class="col-md-12" style="text-align: left">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p style="color: white; font-size: 120%">
                                        {{ date('d-m-Y', strtotime($akreditasi->tanggal_akreditasi)) }}</p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p style="color: white; font-size: 120%">
                                        {{ date('d-m-Y', strtotime($akreditasi->masa_berlaku)) }}</p>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-md-6">
                                    <a target="_blank" href="{{ url("public/$akreditasi->pdf") }}"
                                        class="btn btn-primary"><span class="fa fa-download"> Download</span></a>
                                </div>
                            </div>
                        </div>
                    </div>

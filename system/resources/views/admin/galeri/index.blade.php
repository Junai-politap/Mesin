...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-title-box">
                        ...
                        <h2 class="page-title text-center" style="font-size: 20px;">Data Galeri</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <tbody>
                                @foreach ($list_galeri as $galeri)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                <button class="btn btn-warning" data-toggle="modal"
                                                    data-target=".bs-example-modal-edit{{ $galeri->id }}"><span class="fa fa-edit"></span>
                                                    Edit</button>
                                            ...
                                            <div class="modal fade bs-example-modal-edit{{ $galeri->id }}" tabindex="-1" role="dialog"
                                                aria-labelledby="myLargeModalLabel" aria-hidden="true"
                                                style="display: none;">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="myLargeModalLabel"> Edit Data galeri</h4>
                                                            ...
                                                            <form action="{{ url('admin/galeri', $galeri->id) }}" method="post"
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Gambar
                                                                        Kerja</label>
                                                                        <div class="col-md-6">
                                                                            <img src="{{ url("public/$galeri->foto") }}" style="width: 70%; height: 100%;">
                                                                        </div>
                                                                    <div class="col-sm-4">
                                                                        <input type="file" class="form-control"
                                                                            name="foto" value="{{ $galeri->foto }}" accept=".png, .jpg, .jpeg">
                                                                    </div>
                                                                </div>
                                        ...
                                        <td class="text-center">
                                            <img src="{{ url("public/$galeri->foto") }}" style="width: 50%; height: 150px;">
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeModalLabel"> Tambah Galeri</h4>
